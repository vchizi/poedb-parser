...
file_put_contents('downloaded_page.html', $htmlContent);

$cardsList = extractDivinationCards($htmlContent);
file_put_contents('divination_cards.json', json_encode($cardsList, JSON_PRETTY_PRINT));

echo "Page downloaded and divination cards extracted successfully.";
